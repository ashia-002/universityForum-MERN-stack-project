...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9FF] font-poppins">
      ...
      <div className={`ml-80 pt-32 px-8 flex gap-8 transition-all duration-300
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="flex gap-4">
            {/* Department Dropdown */}
            <select className="w-32 h-16 bg-white border border-[#ECE9FB] rounded-xl px-4 outline-none focus:ring-2 focus:ring-[#533DDE] focus:border-transparent text-[#333333] font-medium">
            ...
            <button
              ...
              className={`w-32 h-16 rounded-xl font-medium transition-colors ${
                activeButton === 'Recent'
