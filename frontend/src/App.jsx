...
import ViewCommunity from "./components/layout/ViewCommunity";
import AnnouncementDashboard from "./components/layout/AnnouncementDashboard";
    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          {/* Profile Route (Updated to use Profile component) */}
          <Route
            path="/profile"
            element={
              <GlobalLayout>
